    ...
    <div className="w-full h-[100vh] bg-[#F0FBF7] py-24">
      ...
      >
        ...
        <div className="bg-white p-5 rounded-lg">
          <div
            className="h-[600px] mt-4 bg-center bg-cover bg-no-repeat transition-background-image duration-300 group relative m-0 flex rounded-xl shadow-xl"
            style={{
              backgroundImage: `url(${
                hoveredImage
                  ? hoveredImage
          ...
          >
            <div className="flex absolute justify-center gap-6 bottom-0">
          ...
          <div className="justify-center w-[100%] gap-6 bottom-40">
            <p className="text-xl text-gray-500">{hoveredDesc}</p>
          </div>
        </div>
      </div>
    </div>
